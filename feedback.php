...
<div class="col-md-6 panel" style="background-image:url(image/feed.jpg); min-height:430px;">
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">shararnur@gmail.com</a><br /><br />
...
<div class="row footer">
        ...
        <div class="col-md-4 box">
            <a href="#" data-toggle="modal" data-target="#developers">Contact</a>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        <div class="row">
                            <div class="col-md-4">
                                <img src="image/nur.jpg" width=110 height=136 alt="Sunny Prakash Tiwari"
                                    class="img-rounded">
                            </div>
                            <div class="col-md-5">
                                <a 
                                    style="color:#202020; font-family:'typo' ; font-size:18px"
                                    title="Find on Facebook">Sharar Nur</a>
                                <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+8801687401067</h4>
                                <h4 style="font-family:'typo' ">Shararnur@gmail.com</h4>
                                <h4 style="font-family:'typo' ">Independent University, Bangladesh</h4>
                            </div>
                        </div>
                    </p>
                </div>
